...
//		mSolarElevationAtmoshpere = (TextView) findViewById(R.id.SolarElevationAtmoshpereTxtFld);
		...
		mLunarElevationAtmosphere.setText(AstroLib.getSexagesimalStr(elevationCorrected));
		double[] sunRS = new double[3];
	    solar.calculateSunRiseTransitSet(sunRS, jd); 
		...
		mIlluminated.setText(oneDigit.format(sunMoonPosition.getMoonIllimunated()* 100) + "%");
		mIslamicLunation.setText(hicriCalendar.getLunation() + "");
		mBrownLunation.setText(hicriCalendar.getLunation()-16096 + "");
		mSunRise.setText( AstroLib.getStringHHMMSSS( sunRS[1]));
		mZenith.setText( AstroLib.getStringHHMMSSS( sunRS[0]));
