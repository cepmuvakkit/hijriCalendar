...
public class MoonCanvasInfoWidget extends AppWidgetProvider {
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
		...
		updateViews.setTextViewText(R.id.ageTxtView,oneDigit.format(moonAgeConjuction) + " days");
		moonCanvasView.setParameters(mLatitude, mLongitude, jd, ΔT, moonPhase,
				moonAgeConjuction > ApplicationConstants.synmonth / 2, 100, 100);
		...
		updateViews.setOnClickPendingIntent(R.id.widget_moon_revised, pendingIntent);
